...
Two separate Vercel projects, two separate `vercel.json` files:
- **`bds`** (this project) → serves `www.bdancestudio.com.my`. Redirects phones to mobile.
- **`bdsmobile`** → serves `mobile.bdancestudio.com.my`. Redirects desktop/iPad to www.
